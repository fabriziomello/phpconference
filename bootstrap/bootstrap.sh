...
APP_DB_USER=phpconference
APP_DB_PASS=phpconference
...
echo "log_line_prefix = '%t [%p]: [%l-1] db=%d,user=%u,app=%a,client=%h '" >> "$PG_CONF"
echo "log_lock_waits = on" >> "$PG_CONF"
echo "log_min_duration_statement = 0" >> "$PG_CONF"
